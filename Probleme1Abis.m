...
[x,fs] = audioread('C:/Users/charl/Documents/Atone.wav');          % On ouvre le fichier
te = 1/fs;
debut = 1;
fin = 0.05*fs;
...
for t = debut:1:fin
    puissanceBruit = puissanceBruit + x(t,1)^2;
end   
...
for t2 = fin:1:taille
  ...
  if (puissanceInst < puissanceBruit * 1.25)   % On compare les deux amplitudes
